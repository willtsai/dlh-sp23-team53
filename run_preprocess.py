...
# authors, but we have modified it to work with our Jupyter notebook
# reproduction code. Original code:
# https://github.com/LuChang-CS/Chet/blob/master/run_preprocess.py 
# Namely, we made these changes:
# - Replaced the main function with a pre_process() function
# - Added a dataset_names parameter to pre_process() which is a list of dataset
#   names to process in one execution of the function (e.g. ['mimic3','mimic4'])
def pre_process(dataset_names, data_saved=False):
    conf = {
        'mimic3': {
            'parser': Mimic3Parser,
            'train_num': 6000,
    ...
    from_saved = data_saved
    data_path = 'data'
    for dataset_name in dataset_names:
        dataset = dataset_name  # mimic3, eicu, or mimic4
